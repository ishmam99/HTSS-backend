...
class TrainingOfferController extends Controller
{
    ...
    {
        $query = TrainingOffer::with('event.trainingCourse.solution','event.trainingCourse.indutry','event.trainingCourse.software')->when($request->status, function($query, $status) {
